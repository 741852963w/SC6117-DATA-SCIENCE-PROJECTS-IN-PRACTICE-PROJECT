            ...
            {!isOpen ? (
              ...
              >
                <div className="flex justify-between items-center mb-5 sm:mb-6">
                  <h2 className="text-lg sm:text-xl font-semibold text-white">Research History</h2>
                  <button
                    onClick={toggleSidebar}
                    className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center bg-black text-white rounded-full shadow-lg hover:bg-neutral-900 transition-all duration-300 group"
