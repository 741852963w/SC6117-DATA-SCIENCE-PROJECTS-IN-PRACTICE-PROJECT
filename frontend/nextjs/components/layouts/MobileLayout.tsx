          ...
          <>
            <div className="flex items-center justify-center gap-5 mb-3">
              ...
              <a href="https://github.com/assafelovic/gpt-researcher" target="_blank" className="text-gray-400 hover:text-gray-300 transition-colors">
                <img src="/img/github.svg" alt="GitHub" width={20} height={20} className="w-5 h-5" />
              </a>
              <a href="https://discord.gg/QgZXvJAccX" target="_blank" className="text-gray-400 hover:text-gray-300 transition-colors">
                <img src="/img/discord.svg" alt="Discord" width={20} height={20} className="w-5 h-5" />
              </a>
              <a href="https://hub.docker.com/r/gptresearcher/gpt-researcher" target="_blank" className="text-gray-400 hover:text-gray-300 transition-colors">
                <img src="/img/docker.svg" alt="Docker" width={20} height={20} className="w-5 h-5" />
              </a>
            </div>
            <div className="text-xs text-gray-400">© {new Date().getFullYear()} GPT Researcher. All rights reserved.</div>
          </>
        ) : (
          <div className="text-xs text-gray-400">VentureProof</div>
        )}
      </footer>
